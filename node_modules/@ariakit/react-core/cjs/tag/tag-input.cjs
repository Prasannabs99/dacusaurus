...
var useTagInput = _MFAH5VLWcjs.createHook.call(void 0, 
  function useTagInput2(_a) {
    ...
    const addValueOnPasteProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, addValueOnPaste);
    const onPaste = _TM5Y6AJUcjs.useEvent.call(void 0, (event) => {
    ...
    const setValueOnChangeProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, setValueOnChange);
    const addValueOnChangeProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, addValueOnChange);
    ...
    const removeOnBackspaceProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, removeOnBackspace);
    ...
    props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      ...
      ref: _TM5Y6AJUcjs.useMergeRefs.call(void 0, store.setInputElement, props.ref),
      onPaste,
      onChange,
      onKeyDown
    });
    props = _QJWSPVEUcjs.useCompositeItem.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, tabbable }, props));
    return props;
  }
);
var TagInput = _MFAH5VLWcjs.forwardRef.call(void 0, function TagInput2(props) {
