...
var _WFEIS2SRcjs = require('./WFEIS2SR.cjs');
...
var useSelectList = _MFAH5VLWcjs.createHook.call(void 0, 
  function useSelectList2(_a) {
    ...
    const context = _P66OGEAYcjs.useSelectContext.call(void 0, );
    store = store || context;
    ...
    const resetOnEscapeProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, resetOnEscape);
    const hideOnEnterProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, hideOnEnter);
    ...
    const headingContext = _react.useContext.call(void 0, _P66OGEAYcjs.SelectHeadingContext);
    ...
    props = _TM5Y6AJUcjs.useWrapElement.call(void 0, 
      props,
      (element2) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _P66OGEAYcjs.SelectScopedContextProvider, { value: store, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, SelectListContext.Provider, { value: setChildStore, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _P66OGEAYcjs.SelectHeadingContext.Provider, { value: headingContextValue, children: element2 }) }) }),
      [store, headingContextValue]
    );
    const hasCombobox = !!store.combobox;
    composite = composite != null ? composite : !hasCombobox && childStore !== store;
    const [element, setElement] = _TM5Y6AJUcjs.useTransactionState.call(void 0, 
      composite ? store.setListElement : null
    );
    const role = _TM5Y6AJUcjs.useAttribute.call(void 0, element, "role", props.role);
    ...
    const hidden = _WFEIS2SRcjs.isHidden.call(void 0, mounted, props.hidden, alwaysVisible);
    ...
    props = _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      ...
      ref: _TM5Y6AJUcjs.useMergeRefs.call(void 0, setElement, props.ref),
      style,
      onKeyDown
    });
    props = _BUKUAI2Fcjs.useComposite.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store }, props), { composite }));
...
var SelectList = _MFAH5VLWcjs.forwardRef.call(void 0, function SelectList2(props) {
