...
var _7ZBP2RUNcjs = require('./7ZBP2RUN.cjs');
...
var useDialog = _MFAH5VLWcjs.createHook.call(void 0, function useDialog2(_a) {
  ...
  const hidden = _WFEIS2SRcjs.isHidden.call(void 0, mounted, props.hidden, props.alwaysVisible);
  ...
  props = _WFEIS2SRcjs.useDisclosureContent.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store }, props));
