...
var _LDUVTD5Ncjs = require('../__chunks/LDUVTD5N.cjs');
...
var _QJWSPVEUcjs = require('../__chunks/QJWSPVEU.cjs');
...
var useComboboxItem = _MFAH5VLWcjs.createHook.call(void 0, 
  function useComboboxItem2(_a) {
    ...
    const selectValueOnClickProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, selectValueOnClick);
    const resetValueOnSelectProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, 
      (_a2 = resetValueOnSelect != null ? resetValueOnSelect : resetValueOnSelectState) != null ? _a2 : multiSelectable
    );
    const hideOnClickProp = _TM5Y6AJUcjs.useBooleanEvent.call(void 0, hideOnClick);
    ...
    props = _TM5Y6AJUcjs.useWrapElement.call(void 0, 
      props,
      (element) => /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _BB26STNRcjs.ComboboxItemValueContext.Provider, { value, children: /* @__PURE__ */ _jsxruntime.jsx.call(void 0, _BB26STNRcjs.ComboboxItemCheckedContext.Provider, { value: selected != null ? selected : false, children: element }) }),
      [value, selected]
    );
    const popupRole = _react.useContext.call(void 0, _BB26STNRcjs.ComboboxListRoleContext);
    ...
    props = _QJWSPVEUcjs.useCompositeItem.call(void 0, _7EQBAZ46cjs.__spreadProps.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, {
      store
    }, props), {
      getItem,
    ...
    props = _LDUVTD5Ncjs.useCompositeHover.call(void 0, _7EQBAZ46cjs.__spreadValues.call(void 0, { store, focusOnHover }, props));
    return props;
  }
);
var ComboboxItem = _MFAH5VLWcjs.memo.call(void 0, 
  _MFAH5VLWcjs.forwardRef.call(void 0, function ComboboxItem2(props) {
